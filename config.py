...
class Config(object):
    ...
    BOT_TOKEN = os.environ.get("BOT_TOKEN", "7871777689:AAFuVTnjxiVa6OqR1BwCevMf-NIuJcJFXu8") 
    ...
    FORCE_SUB_CHANNELS = os.environ.get('FORCE_SUB_CHANNELS', '+ecWFJBaAGZpjMGY1').split(',')
